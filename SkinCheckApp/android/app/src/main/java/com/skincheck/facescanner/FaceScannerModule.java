...
public class FaceScannerModule extends ReactContextBaseJavaModule {
  ...
  public void captureCurrentMesh(Promise promise) {
    try {
      ...
      if (verticesBuf == null || uvsBuf == null || indicesBuf == null) {
        promise.reject("NO_MESH", "Mesh data not available for the tracked face.");
        return;
      }
      ...
      promise.reject("MESH_CAPTURE_FAILED", "Could not capture mesh data.", e);
    }
  }
