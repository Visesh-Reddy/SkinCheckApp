...
import { FaceMeshData, FacePose, QualityCheckResult } from '../types/FaceScan.types';
...
export async function captureCurrentMesh(): Promise<FaceMeshData> {
  return NativeFaceScanner.captureCurrentMesh();
}
